            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  len==0?const SizedBox(): CustomMaterialButton(onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> QuizView(len: len, flashcards: flashcards,)));
                  },),
                ],
              ),
            ),
