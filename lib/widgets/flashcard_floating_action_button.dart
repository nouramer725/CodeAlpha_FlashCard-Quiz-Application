                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      decoration: InputDecoration(
                                        ...
                                        labelText: 'Enter True Answer',
                                      ),
                                      keyboardType: TextInputType.text,
                                      controller: FlashCardsCubit.get(context).trueAnswerController,
                                      validator: (value) {
                                        if (value?.isEmpty ?? true) {
                                          return 'True Answer must not be empty';
                                        }
                                        return null;
                                      },
                                    ),
                                    ...
                                    TextFormField(
                                      decoration: InputDecoration(
                                        ...
                                        labelText: 'Enter False Answer 2',
                                      ),
                                      keyboardType: TextInputType.text,
                                      controller: FlashCardsCubit.get(context).falseAnswer2Controller,
                                      validator: (value) {
                                        if (value?.isEmpty ?? true) {
                                          return 'False Answer 2 must not be empty';
                                        }
                                        return null;
                                      },
                                    ),
                                    ...
                                    TextFormField(
                                      decoration: InputDecoration(
                                        ...
                                        labelText: 'Enter False Answer 3',
                                      ),
                                      keyboardType: TextInputType.text,
                                      controller: FlashCardsCubit.get(context).falseAnswer3Controller,
                                      validator: (value) {
                                        if (value?.isEmpty ?? true) {
                                          return 'False Answer 3 must not be empty';
                                        }
                                        return null;
                                      },
                                    ),
